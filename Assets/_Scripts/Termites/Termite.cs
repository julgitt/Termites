...
public class Termite : MonoBehaviour
{
    ...
    [SerializeField] private float _rotationStrength = .25f;
    ...
    private void Move()
    {
        float rotationSpeed = (_rotationEndTime < Time.time) ? _steerStrength : _rotationSpeed;
    ...
    private Vector2 GetDesiredDirection()
    {
        ...
        return (_desiredDirection + (Random.insideUnitCircle * _rotationStrength)).normalized;
    }
